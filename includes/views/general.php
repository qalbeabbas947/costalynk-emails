            ...
            <tbody>
                <tr> 
                    <td width="30%" align="left" valign="top">
						<strong><label align="left" for="ld-cms-schedule-excluded-roles"><?php _e( 'Site Admin Email', 'coastalynk-emails' ); ?></label></strong>
					</td>
                    <td width="70%">
                ...
                <tr> 
                    <td width="30%" align="left" valign="top"> 
						<strong><label align="left" for="ld-cms-schedule-excluded-roles"><?php _e( 'NPA Admin Email', 'coastalynk-emails' ); ?></label></strong>
					</td>
                    <td width="70%">
